tinymce.PluginManager.add("chatgpt", function (editor, url) {
  const openDialog = function () {
     ...
     */
    let PROMPTS = OPENAI.prompts
      ? OPENAI.prompts.map((prompt) => {
    ...
    return editor.windowManager.open({
      ...
      onSubmit: function (api) {
        ...
        /**
         * Get the current selection and set it as the default input
         * @type {{max_tokens: *, temperature: *, model: *, prompt: *}}
         */
        const ChatGPT = {
          model: OPENAI.model,
          prompt: prompt + input,
  ...
  editor.ui.registry.addIcon(
    "chatgpt",
    '<svg height="1em" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">\n' +
